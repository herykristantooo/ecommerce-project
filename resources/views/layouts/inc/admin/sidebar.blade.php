    ...
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
            ...
            <li class="nav-item">
                <a class="nav-link" data-bs-toggle="collapse" href="#product-item" aria-expanded="false"
                    aria-controls="product-item">
                    <i class="mdi mdi-circle menu-icon"></i>
                    <span class="menu-title">Products</span>
                    <i class="menu-arrow"></i>
                </a>
                <div class="collapse" id="product-item">
                    <ul class="nav flex-column sub-menu">
            ...
            <li class="nav-item">
                <a class="nav-link" href="pages/icons/mdi.html">
                    ...
                    <span class="menu-title">Site Seting</span>
                </a>
            </li>
        </ul>
    </nav>
